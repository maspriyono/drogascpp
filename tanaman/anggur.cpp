...
/*Anggur::Anggur(int I,int HM,int TD,int TP,int U,int Tipan,Point P,int HB,int HP,int EOD,int ES) {
	ID	= I;
	HappyMeter = HM;
	TitikDewasa = TD;
	TitikPanen = TP;
...
Anggur::Anggur(const Anggur& copied) {
	ID = copied.ID;
